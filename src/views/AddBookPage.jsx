...
function AddBookPage() {
    ...
    function add_book_handler(e) {
        ...
        if (newBook.title && newBook.cover && newBook.author) {
            ...
            alert("Please Enter the Compolusory Fields");
        }
            ...
            <div className="container">
                ...
                <form className="add-form">
                    ...
                    <div className="form-control">
                        ...
                        <textarea type="text" name="synopsis" placeholder="Add a synopsis..." />
                    </div>

                    <button onClick={(e) => add_book_handler(e)} className="btn btn-block">Save Book</button>
                </form>
